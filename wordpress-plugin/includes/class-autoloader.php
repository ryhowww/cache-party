...
spl_autoload_register( function ( $class_name ) {
    $classes = [
        ...
        'CacheParty\\Assets\\CSS_Aggregator'    => __DIR__ . '/assets/class-css-aggregator.php',
        'CacheParty\\Assets\\CSS_Minifier'      => __DIR__ . '/assets/class-css-minifier.php',
        'CacheParty\\Assets\\Cache_Manager'     => __DIR__ . '/assets/class-cache-manager.php',
